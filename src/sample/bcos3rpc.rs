...
pub fn test_bcos3sdk_ffi_rpc() -> Result<i32, KissError> {
    unsafe {
        ...
        //let arc_context = Arc::new(context);
        //let pcontext =
        bcos_rpc_get_group_peers(p_sdk,
                                 str2p!(groupname),
                                 Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                 Bcos3SDKFuture::to_c_ptr(&cbfuture));
        let status = cbfuture.wait();
        ...
        let cbfuture = Bcos3SDKFuture::create(seq, "bcos_rpc_get_total_transaction_count", "for test");
        cbfuture.display();
        //let arc_context = Arc::new(context);
        //let pcontext =
        bcos_rpc_get_total_transaction_count(p_sdk,
                                             str2p!(groupname),
                                             0 as *const c_char,
                                             Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                             Bcos3SDKFuture::to_c_ptr(&cbfuture));
        ...
        //let pcontext =
        let key = "";
        bcos_rpc_get_system_config_by_key(p_sdk,
                                          str2p!(groupname),
                                          0 as *const c_char,
                                          str2p!(key),
                                          Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
        ...
        //let arc_context = Arc::new(context);
        //let pcontext =
        bcos_rpc_get_consensus_status(p_sdk,
                                      str2p!(groupname),
                                      0 as *const c_char,
                                      Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                      Bcos3SDKFuture::to_c_ptr(&cbfuture));
        ...
        //let arc_context = Arc::new(context);
        //let pcontext =
        bcos_rpc_get_sync_status(p_sdk,
                                 str2p!(groupname),
                                 0 as *const c_char,
                                 Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                 Bcos3SDKFuture::to_c_ptr(&cbfuture));
        ...
        //let arc_context = Arc::new(context);
        //let pcontext =
        bcos_rpc_get_pending_tx_size(p_sdk,
                                     str2p!(groupname),
                                     0 as *const c_char,
                                     Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                     Bcos3SDKFuture::to_c_ptr(&cbfuture));
...
//--------------------------------------------------------------------------------------
        ...
        //let pcontext =
        cbfuture.display();
        bcos_rpc_get_observer_list(p_sdk,
                                   str2p!(groupname),
                                   0 as *const c_char,
                                   Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                   Bcos3SDKFuture::to_c_ptr(&cbfuture));
        ...
        //let pcontext =
        cbfuture.display();
        bcos_rpc_get_sealer_list(p_sdk,
                                 str2p!(groupname),
                                 0 as *const c_char,
                                 Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                 Bcos3SDKFuture::to_c_ptr(&cbfuture));
        ...
        //let pcontext =
        cbfuture.display();
        bcos_rpc_get_block_number(p_sdk,
                                  str2p!(groupname),
                                  0 as *const c_char,
                                  Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
                                  Bcos3SDKFuture::to_c_ptr(&cbfuture));
        ...
        //let pcontext =
        cbfuture.display();
        let limit = bcos_rpc_get_block_limit(p_sdk,
                                             str2p!(groupname),
        );
        ...
        //let pcontext =
        cbfuture.display();
        bcos_rpc_get_block_hash_by_number(p_sdk,
                                          str2p!(groupname),
                                          0 as *const c_char,
                                          1,
                                          Bcos3SDKFuture::bcos_callback as BCOS3SDK_CALLBACK_FUNC,
        ...
        //let pcontext =
        cbfuture.display();
        bcos_rpc_get_block_by_hash(p_sdk,
                                   str2p!(groupname),
                                   0 as *const c_char,
        ...
        //let pcontext =
        cbfuture.display();
        bcos_rpc_get_transaction_receipt(p_sdk,
                                         str2p!(groupname),
                                         0 as *const c_char,
                                         str2p!(txhash),
                                         0,
        ...
        let txhash = "0xf38851e1aecf890f7f978431dc61c9116f7565f5aab16f17353b3cb4e49853ca";
        cbfuture.display();
        bcos_rpc_get_transaction(p_sdk,
                                 str2p!(groupname),
                                 0 as *const c_char,
                                 str2p!(txhash),
                                 0,
        ...
        //let pcontext =
        cbfuture.display();
        bcos_event_sub_subscribe_event(p_sdk,
                                       str2p!(groupname),
        ...
        bcos_amop_subscribe_topic_with_cb(p_sdk, topic.as_ptr(), amop_sub_callback, Bcos3SDKFuture::to_c_ptr(&cbfuture));
